...
prepareKey:
    ...
    initialize:             //initialize seenArray to 0s
        str r1, [r3, r2]
        add r2, r2, #4
        cmp r2, #104
        ble initialize
    ...
    loop3:
        ldr r8, =alphabet   //load the alphabet
...
encode:
    ...
    loop4:
        mov r7, #0
        ldrb r5, [r0, r3]   //r5 = str[r3]
        add r3, r3, #1      //r3++
        cmp r3, #60         //end of array?
        beq done1
    check:
        ldrb r6, [r8, r7]   //r6 = alphabet[r7]
        add r7, r7, #1      //r7++
        cmp r5, r6          //if r5 == r6
        bne check
        sub r7, r7, #1
        ldrb r6, [r1, r7]   //r6 = key[r7]
        add r7, r7, #1
        sub r3, r3, #1
        strb r6, [r2, r3]   //e[r3] = r6
        add r3, r3, #1
        b loop4
    done1:
