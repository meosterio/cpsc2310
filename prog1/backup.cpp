 ...
 int main(int argc, char const *argv[]) {
   ...
   while (fin >> read && error == false) {
     ...
     //check for all the opcodes which increment the location counter by 1
       ...
       //check for opcodes that have a value with them
       else {
         char name[15];
         char value[15];
         ...
         if (
           ...
           //name == "bipush" ||
           //find(name.begin(), name.end(), "bipush") ||
           /*name.compare("bipush") == 0 || name.compare("iload") == 0 ||
           name.compare("ifeq") == 0 || name.compare("ifge") == 0 ||
           name.compare("ifgt") == 0 || name.compare("ifle") == 0 ||
           name.compare("iflt") == 0 || name.compare("ifne") == 0 ||
           name.compare("goto") == 0 || name.compare("jsr") == 0 ||
           name.compare("invokevirtual") == 0)*/
           {
